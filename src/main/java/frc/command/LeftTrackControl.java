...
public class LeftTrackControl extends Command {
    public driveSubsystem driveSubsystem;
    public Supplier<Double> power;
    public LeftTrackControl(driveSubsystem driveSubsystem, Supplier<Double> power) {
    ...
    public void execute() {
        ...
        driveSubsystem.LeftTrack(power);
    }
